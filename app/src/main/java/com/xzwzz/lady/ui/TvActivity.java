...
import com.xzwzz.lady.ui.adapter.TvLeftAdapter;
import com.xzwzz.lady.ui.adapter.TvRightAdapter;
...
public class TvActivity extends AppCompatActivity implements BaseQuickAdapter.OnItemClickListener {
    ...
    private com.xzwzz.lady.widget.ViewStatusManager viewStatusmanager;
